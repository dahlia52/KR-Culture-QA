...
if __name__ == '__main__':
    ...
    input_file = os.path.join(project_root, 'resource', 'QA', 'final_finetuned3_q.json')
    output_file = os.path.join(project_root, 'resource', 'QA', 'final_finetuned3_q_preprocessed.json')
