...
# 실행 명령어
python src/inference_transformers_by_type+.py --model_id "./models/fine-tuned-model-선다형-단답형-서술형-NEW-merged-bf16" --output "./resource/QA/final_verify_finetuned1_q.json" --quantize --verify